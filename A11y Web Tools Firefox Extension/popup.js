const POPUP_LOADING_TIMEOUT = 5000;
...
`.trim();
    ...
    return `mailto:wywyguyfirefoxextensions@gmail.com?subject=${subject}&body=${body}`;
}
    ...
    try {
        ...
        container.innerHTML = `
            <div id="settingsControls">
                ...
                <div class="footer">
                    <div class="footer"><i><a class="supportLink" title="Learn how to use A11y Web Tools" href="help.html" target="_blank">How to Use</a>&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp<a class="supportLink" title="Contact Wyatt Nilsson" href="#" id="supportLink">Contact</a></i></div>
        ...
        clickActions.forEach(id => {
            ...
            el.addEventListener("click", async () => {
                try {
                    ...
                    console.error(`Error sending message for click action ${id}:`, error);
                }
            });
        });
        const changeActions = [
        ...
        changeActions.forEach(id => {
            ...
            el.addEventListener("change", async (event) => {
                ...
                try {
                    ...
                    console.error(`Error sending message for change action ${id}:`, error);
                }
            });
        });

        // Load current settings and color inputs accordingly
        const settings = await chrome.runtime.sendMessage({ action: "loadSettings" });
